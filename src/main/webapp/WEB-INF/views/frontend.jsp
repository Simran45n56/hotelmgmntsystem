	...
	<div class="features">
		<div class="container">
			<div class="row">
				...
				<!-- Icon Box -->
				<div class="col-lg-4">
					<div class=" d-flex flex-column align-items-center justify-content-start text-center">
						<img src="${room.room_image}" width="400" />
						<div class="icon_box_title"><h2>${room.room_type }</h2></div>
						<div class="icon_box_text">
						<c:choose>
						<c:when test="${room.room_status eq true }">
							<p>Room available with us.</p>
							</c:when>
						<c:when test="${room.room_status eq false }">
							<p>Room un-available with us.</p>
							</c:when>
						</c:choose>
