...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="#">The HMS</a></div>
			<div class="ml-auto d-flex flex-row align-items-center justify-content-start">
				<nav class="main_nav">
					<ul class="d-flex flex-row align-items-start justify-content-start">
						...
						<li><a href="/reservation">Enter Reservation details</a></li>
					</ul>
				</nav>
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title">Enter Reservation Details</div>
	...
	<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Add reservation details</h1>
                </div>
                <!-- /.col-lg-12 -->
	      ...
	      <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                        ...
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" name="reservation_name" type="text" placeholder="Enter name here" required>
                                            <p class="help-block">Enter name in block letters.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Phone number</label>
                                            <input class="form-control" type="text" name="reservation_number" placeholder="Enter number here" required>
                                        </div>
                                         <div class="form-group">
                                            <label>Email address</label>
                                            <input class="form-control" type="text" name="reservation_email" placeholder="Enter email  here" required>
                                        </div>
                                          <div class="form-group">
                                            <label>Address</label>
                                            <input class="form-control" type="text" name="reservation_address" placeholder="Enter address  here" required>
                                        </div>
                                        <div class="form-group">
